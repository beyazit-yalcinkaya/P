...
eventDecl : EVENT name=iden cardinality? priority? (COLON type)? SEMI
          | EVENT name=iden priority? cardinality? (COLON type)? SEMI
          ;
cardinality : ASSERT IntLiteral
            | ASSUME IntLiteral
            ;
priority : PRIORITY IntLiteral ;
...
// has scope
implMachineDecl : MACHINE name=iden cardinality? priority? receivesSends* machineBody
                | MACHINE name=iden priority? cardinality? receivesSends* machineBody
                ;
...
eventDrivenRTAModuleBody : LBRACE eventDrivenController eventDrivenController eventDrivenController* decisionModule trigger trigger* RBRACE ;
timeDrivenRTAModuleBody : LBRACE timeDrivenController timeDrivenController timeDrivenController* decisionModule RBRACE ;
...
decisionModulePeriod : funName=iden COLON decisionPeriod=IntLiteral ;
